...
const translations = {
  en: {
    ...
    'elec.subtitle': 'Control Engineering, Applied Electronics & Intelligent Infrastructure',
    'elec.heroLead': 'Karuna Electronics designs and implements advanced industrial control, applied electronics, and connected infrastructure solutions for organizations seeking greater operational efficiency, technological resilience, and real-time traceability.',
    'elec.heroDesc': 'We integrate electronic engineering, automation, and digital systems to transform physical assets into intelligent, secure, and connected systems. We operate under an end-to-end model: from technical assessment and architecture design through field implementation and commissioning.',
    'elec.specialtiesTitle': 'Our Capabilities',

    // IoT
    'elec.iot.title': 'Industrial IoT Architectures',
    'elec.iot.lead': 'We design industrial IoT infrastructures focused on operational reliability and data-driven decision making.',
    'elec.iot.item1': 'Industrial sensor network design (energy, vibration, pressure, temperature, humidity)',
    'elec.iot.item2': 'Edge computing architectures for local processing',
    'elec.iot.item3': 'Secure integration with cloud platforms',
    'elec.iot.item4': 'Industrial protocols (MQTT, Modbus TCP/IP, OPC-UA)',
    'elec.iot.item5': 'Predictive maintenance models',
    'elec.iot.item6': 'Multi-site remote monitoring',
    'elec.iot.closing': 'Every deployment is focused on scalability, security, and compatibility with existing infrastructure.',

    // Control Systems
    'elec.control.title': 'Automation & Control Systems',
    'elec.control.lead': 'We design and execute industrial automation projects under international standards. We work with leading platforms: Siemens, Allen-Bradley, Schneider Electric.',
    'elec.control.item1': 'PLC programming and advanced control logic',
    'elec.control.item2': 'SCADA integration and HMI design',
    'elec.control.item3': 'Electrical control panel design and fabrication',
    'elec.control.item4': 'Motion control and variable frequency drives',
    'elec.control.item5': 'Instrumentation and legacy machinery digitalization',
    'elec.control.closing': 'We deliver turnkey solutions with technical documentation, FAT/SAT testing, and on-site commissioning.',

    // Computer Vision & Edge Analytics
    'elec.vision.title': 'Computer Vision & Edge Analytics',
    'elec.vision.lead': 'We implement automated inspection systems and real-time visual analytics for demanding production environments.',
    'elec.vision.item1': 'Automated quality control',
    'elec.vision.item2': 'Label verification and traceability',
    'elec.vision.item3': 'In-line defect detection',
    'elec.vision.item4': 'Direct integration with PLCs and MES systems',
    'elec.vision.item5': 'AI-powered image processing at the edge',
    'elec.vision.closing': 'We reduce rework, waste, and dependency on manual inspection.',

    // Electronic Security Infrastructure
    'elec.security.title': 'Electronic Security Infrastructure',
    'elec.security.lead': 'We design physical security systems with a focus on operational continuity.',
    'elec.security.item1': 'Enterprise CCTV architectures',
    'elec.security.item2': 'Integration with Hikvision and other leading platforms',
    'elec.security.item3': 'Access control (biometric, RFID, secure credentials)',
    'elec.security.item4': 'Perimeter protection',
    'elec.security.item5': 'Integration with emergency protocols',
    'elec.security.closing': 'Security is treated as critical infrastructure, not an accessory.',

    // Applied Electronics & Embedded Systems
    'elec.embedded.title': 'Applied Electronics & Embedded Systems',
    'elec.embedded.lead': 'We develop specialized hardware when commercial solutions don\'t meet technical or operational requirements.',
    'elec.embedded.item1': 'Custom PCB design',
    'elec.embedded.item2': 'Embedded firmware development',
    'elec.embedded.item3': 'Edge modules for local processing',
    'elec.embedded.item4': 'Custom sensor interfaces',
    'elec.embedded.item5': 'Pilot batch production',
    'elec.embedded.closing': 'We transform complex technical requirements into functional devices ready for industrial operation.',

    // Execution Model
    'elec.approach.title': 'Execution Model',
    'elec.approach.tagline': 'End-to-end: from technical assessment to commissioning.',
    'elec.approach.desc': 'Karuna Electronics operates under a structured model that ensures traceability, quality, and operational alignment at every phase of the project.',
    'elec.approach.roleTitle': 'Every project includes:',
    'elec.approach.role1': 'On-site technical assessment and requirements engineering',
    'elec.approach.role2': 'Architecture design with certified component selection',
    'elec.approach.role3': 'Complete technical documentation (drawings, diagrams, FAT/SAT testing)',
    'elec.approach.role4': 'Field implementation with commissioning and operational handover',

    // Execution Phases
    'elec.delivery.title': 'Execution Phases',
    'elec.delivery.flow': 'Assessment \u2192 Design \u2192 Prototyping \u2192 Implementation \u2192 Commissioning',
    'elec.delivery.desc': 'We don\'t just deliver technology. We deliver functional systems — documented and aligned to operational objectives.',

    // CTA
    'elec.cta.title': 'Ready to Talk?',
    'elec.cta.lead': 'If any of these sound like your world:',
    'elec.cta.item1': 'Industrial IoT',
    'elec.cta.item2': 'Automation & control',
    'elec.cta.item3': 'Computer vision',
    'elec.cta.item4': 'Electronic security',
    'elec.cta.item5': 'Custom electronics',
  ...
  es: {
    ...
    // Electronics Deck
    'elec.title': 'Karuna Electronics',
    'elec.subtitle': 'Ingeniería de Control, Electrónica Aplicada e Infraestructura Inteligente',
    'elec.heroLead': 'Karuna Electronics diseña e implementa soluciones avanzadas de control industrial, electrónica aplicada e infraestructura conectada para organizaciones que buscan mayor eficiencia operativa, resiliencia tecnológica y trazabilidad en tiempo real.',
    'elec.heroDesc': 'Integramos ingeniería electrónica, automatización y sistemas digitales para transformar activos físicos en sistemas inteligentes, seguros y conectados. Operamos bajo un modelo end-to-end: desde evaluación técnica y diseño de arquitectura hasta implementación en campo y comisionamiento.',
    'elec.specialtiesTitle': 'Nuestras Capacidades',

    // IoT
    'elec.iot.title': 'Arquitecturas IoT Industriales',
    'elec.iot.lead': 'Diseñamos infraestructuras IoT industriales orientadas a confiabilidad operativa y toma de decisiones basada en datos.',
    'elec.iot.item1': 'Diseño de redes de sensores industriales (energía, vibración, presión, temperatura, humedad)',
    'elec.iot.item2': 'Arquitecturas edge computing para procesamiento local',
    'elec.iot.item3': 'Integración segura con plataformas cloud',
    'elec.iot.item4': 'Protocolos industriales (MQTT, Modbus TCP/IP, OPC-UA)',
    'elec.iot.item5': 'Modelos de mantenimiento predictivo',
    'elec.iot.item6': 'Monitoreo remoto multi-sitio',
    'elec.iot.closing': 'Enfocamos cada despliegue en escalabilidad, seguridad y compatibilidad con infraestructura existente.',

    // Automatización y Sistemas de Control
    'elec.control.title': 'Automatización y Sistemas de Control',
    'elec.control.lead': 'Diseñamos y ejecutamos proyectos de automatización industrial bajo estándares internacionales. Trabajamos con plataformas líderes: Siemens, Allen-Bradley, Schneider Electric.',
    'elec.control.item1': 'Programación de PLCs y lógica de control avanzada',
    'elec.control.item2': 'Integración SCADA y diseño de HMI',
    'elec.control.item3': 'Diseño y fabricación de tableros eléctricos',
    'elec.control.item4': 'Control de movimiento y variadores de frecuencia',
    'elec.control.item5': 'Instrumentación y digitalización de maquinaria legacy',
    'elec.control.closing': 'Entregamos soluciones llave en mano con documentación técnica, pruebas FAT/SAT y comisionamiento en sitio.',

    // Visión Artificial y Analítica en el Borde
    'elec.vision.title': 'Visión Artificial y Analítica en el Borde',
    'elec.vision.lead': 'Implementamos sistemas de inspección automatizada y analítica visual en tiempo real para entornos productivos exigentes.',
    'elec.vision.item1': 'Control de calidad automatizado',
    'elec.vision.item2': 'Verificación de etiquetas y trazabilidad',
    'elec.vision.item3': 'Detección de defectos en línea',
    'elec.vision.item4': 'Integración directa con PLCs y sistemas MES',
    'elec.vision.item5': 'Procesamiento de imágenes con IA en el borde',
    'elec.vision.closing': 'Reducimos reprocesos, mermas y dependencia de inspección manual.',

    // Infraestructura de Seguridad Electrónica
    'elec.security.title': 'Infraestructura de Seguridad Electrónica',
    'elec.security.lead': 'Diseñamos sistemas de seguridad física con enfoque en continuidad operativa.',
    'elec.security.item1': 'Arquitecturas CCTV empresariales',
    'elec.security.item2': 'Integración con Hikvision y otras plataformas líderes',
    'elec.security.item3': 'Control de acceso (biométrico, RFID, credenciales seguras)',
    'elec.security.item4': 'Protección perimetral',
    'elec.security.item5': 'Integración con protocolos de emergencia',
    'elec.security.closing': 'La seguridad es tratada como infraestructura crítica, no como accesorio.',

    // Electrónica Aplicada y Sistemas Embebidos
    'elec.embedded.title': 'Electrónica Aplicada y Sistemas Embebidos',
    'elec.embedded.lead': 'Desarrollamos hardware especializado cuando la solución comercial no cubre requerimientos técnicos u operativos.',
    'elec.embedded.item1': 'Diseño de PCBs a medida',
    'elec.embedded.item2': 'Desarrollo de firmware embebido',
    'elec.embedded.item3': 'Módulos edge para procesamiento local',
    'elec.embedded.item4': 'Interfaces de sensores personalizadas',
    'elec.embedded.item5': 'Producción en lotes piloto',
    'elec.embedded.closing': 'Transformamos requerimientos técnicos complejos en dispositivos funcionales listos para operación industrial.',

    // Modelo de Ejecución
    'elec.approach.title': 'Modelo de Ejecución',
    'elec.approach.tagline': 'End-to-end: de la evaluación técnica al comisionamiento.',
    'elec.approach.desc': 'Karuna Electronics opera bajo un modelo estructurado que garantiza trazabilidad, calidad y alineación operativa en cada fase del proyecto.',
    'elec.approach.roleTitle': 'Cada proyecto incluye:',
    'elec.approach.role1': 'Evaluación técnica en sitio e ingeniería de requerimientos',
    'elec.approach.role2': 'Diseño de arquitectura con selección de componentes certificados',
    'elec.approach.role3': 'Documentación técnica completa (planos, diagramas, pruebas FAT/SAT)',
    'elec.approach.role4': 'Implementación en campo con comisionamiento y transferencia operativa',

    // Fases de Ejecución
    'elec.delivery.title': 'Fases de Ejecución',
    'elec.delivery.flow': 'Evaluación \u2192 Diseño \u2192 Prototipado \u2192 Implementación \u2192 Comisionamiento',
    'elec.delivery.desc': 'No solo entregamos tecnología. Entregamos sistemas funcionales, documentados y alineados a objetivos operativos.',

    // CTA
    'elec.cta.title': '¿Listo para hablar?',
    'elec.cta.lead': 'Si algo de esto suena a tu mundo:',
    'elec.cta.item1': 'IoT industrial',
    'elec.cta.item2': 'Automatización y control',
    'elec.cta.item3': 'Visión artificial',
    'elec.cta.item4': 'Seguridad electrónica',
    'elec.cta.item5': 'Electrónica a medida',
