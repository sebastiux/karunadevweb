...
const PresentationDeck = () => {
  ...
  const generateWhatsAppMessage = () => {
    ...
    if (language === 'es') {
      return `¡Hola! Hablé con Karu en su presentation deck.\n\nEstoy buscando ayuda con: ${needs || 'soluciones tecnológicas'}\n\n¿Podemos agendar una llamada?`;
    }
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, {
        ...
        role: 'assistant',
        content: language === 'es'
          ? 'Me encantaría saber más sobre tus necesidades. Contáctanos directamente por WhatsApp y nuestro equipo te ayudará.'
